...
public class CommandOreDictifyStone extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String as[]) {
        try {
            ...
            // sender.func_110122_a(ChatMessageComponent.func_111077_e(String.format("commands.oredictifystone.ok",
            // num)).func_111059_a(EnumChatFormatting.GREEN));
