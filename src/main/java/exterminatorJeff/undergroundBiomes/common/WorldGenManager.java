...
public class WorldGenManager {
    ...
    public WorldGenManager(long par1, int _dimension, OreUBifier oreUBifier, UndergroundBiomeSet biomeSet,
        ...
        GenLayer[] gen = GenLayerUnderground
            .initializeAllBiomeGenerators(par1, UndergroundBiomes.biomeSize(), biomeSet);
    ...
    public boolean inChunkGenerationAllowed() {
        return UndergroundBiomes.instance()
            .inChunkGenerationAllowed(dimension);
    }
    ...
    public void preBiomeDecorate(DecorateBiomeEvent.Pre event) {
        ...
        undergroundBiomesForGeneration = loadUndergroundBlockGeneratorData(
            undergroundBiomesForGeneration,
            event.chunkX,
            event.chunkZ,
            16,
            16);
        villageStoneChanger.setStoneCode(getUndergroundBiomeGenAt(event.chunkX, event.chunkZ).fillerBlockCodes);
    }
    ...
    public BiomeGenUndergroundBase[] loadUndergroundBlockGeneratorData(
        BiomeGenUndergroundBase[] par1ArrayOfBiomeGenBase, int par2, int par3, int par4, int par5) {
        return this.getUndergroundBiomeGenAt(par1ArrayOfBiomeGenBase, par2, par3, par4, par5);
    }

    public BiomeGenUndergroundBase[] getUndergroundBiomeGenAt(BiomeGenUndergroundBase[] biomesArrayPar, int par2,
    ...
    public BiomeGenUndergroundBase[] cacheUndergroundBiomeGenAt(BiomeGenUndergroundBase[] biomesArrayPar, int par2,
        int par3, int par4, int par5) {
        BiomeGenUndergroundBase[] biomesArray = biomesArrayPar;
    ...
    public ChunkPosition findUndergroundBiomePosition(int par1, int par2, int par3,
        List<BiomeGenUndergroundBase> par4List, Random par5Random) {
        IntCache.resetIntCache();
    ...
    public void setChunkProvider(World world) {
        ...
        if (currentProvider instanceof UBChunkProvider) {
            ...
            if (currentProvider instanceof ChunkProviderGenerate) {
                ...
                accessChunkProvider.setIChunkProvider(
                    world,
    ...
    public void setServedChunkProvider(WorldServer world) {
        ...
        if (currentProvider instanceof UBChunkProvider) {
            ...
            if ((currentProvider instanceof ChunkProviderGenerate) || (currentProvider.getClass()
                .getName()
                .contains("ChunkProviderBOP")
                || (currentProvider.getClass()
                    .getName()
                    .contains("ChunkProviderTwilightForest")
                    || (currentProvider.getClass()
                        .getName()
                        .contains("BWG4ChunkProvider")
                        || (currentProvider.getClass()
                            .getName()
                            .contains("ChunkProviderRTG")))))) {
                providerFromChunkServer.setField(
                    currentServer,
                    new UBChunkProvider(currentProvider, this.villageStoneSource, this.dimension));
            }
        }
