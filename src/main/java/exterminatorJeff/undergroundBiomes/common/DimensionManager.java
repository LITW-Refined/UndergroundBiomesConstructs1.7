...
public class DimensionManager implements UBSetProviderRegistry {
    ...
    private UndergroundBiomeSet biomeSet(int dimension) {
        ...
        for (UndergroundBiomeSetProvider provider : this.ubSetProviders) {
            UndergroundBiomeSet changedResult = provider.modifiedBiomeSet(dimension, dimensionSeed(dimension), result);
    ...
    public void onBiomeDecorate(DecorateBiomeEvent.Post event) {
        ...
        if (UndergroundBiomes.instance()
            .settings().ubActive.value() == false) return;
    ...
    public void onVillageSelectBlock(GetVillageBlockID e) {
        ...
        if (UndergroundBiomes.instance()
            .gotWorldSeed()) villageWorldGenManager.onVillageSelectBlock(e);
    }
    ...
    public void onVillageSelectMeta(GetVillageBlockMeta e) {
        ...
        if (villageWorldGenManager == null) return;
        if (UndergroundBiomes.instance()
            .gotWorldSeed()) villageWorldGenManager.onVillageSelectMeta(e);
    }

    private ArrayList<UndergroundBiomeSetProvider> ubSetProviders = new ArrayList<UndergroundBiomeSetProvider>();
    ...
    public void redoOres(int x, int z, World world) {
        if (UndergroundBiomes.instance()
            .settings().ubActive.value() == false) return;
        if (UndergroundBiomes.instance()
            .settings().ubOres.value() == false) return;
