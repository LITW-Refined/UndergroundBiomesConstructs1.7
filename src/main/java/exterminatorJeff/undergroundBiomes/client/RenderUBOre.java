...
public class RenderUBOre implements ISimpleBlockRenderingHandler {
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId,
        ...
        IIcon self = ubifier.baseStone(renderedBlock)
            .getIcon(0, metadata);
        renderer.renderBlockUsingTexture(ubifier.baseStone(renderedBlock), x, y, z, self);
        IIcon overlay = ubifier.overlayBlock(renderedBlock)
            .getIcon(0, 0);
    ...
    private static Accessor<RenderingRegistry, Map> blockRenderers = new Accessor<RenderingRegistry, Map>(
        RenderingRegistry.class);

    public static Object rendered(Integer ID) {
        return blockRenderers.get(RenderingRegistry.instance())
            .get(ID);
    }
    ...
    public void renderOreBlockAsItem(Block stone, Block overlay, int p_147800_2_, float p_147800_3_,
        RenderBlocks renderer) {
        // logger.info("rendering");
        ...
        int k;
        {
            ...
            renderer.renderFaceYNeg(
                ...
                0.0D,
                0.0D,
                renderer.getBlockIconFromSideAndMetadata(stone, 0, p_147800_2_));
            renderer.renderFaceYNeg(
                stone,
                0.0D,
                0.0D,
                0.0D,
                renderer.getBlockIconFromSideAndMetadata(overlay, 0, p_147800_2_));
            tessellator.draw();
            ...
            renderer.renderFaceYPos(
                ...
                0.0D,
                0.0D,
                renderer.getBlockIconFromSideAndMetadata(stone, 1, p_147800_2_));
            renderer.renderFaceYPos(
                overlay,
                0.0D,
                0.0D,
                0.0D,
                renderer.getBlockIconFromSideAndMetadata(overlay, 1, p_147800_2_));
            tessellator.draw();
            ...
            renderer.renderFaceZNeg(
                ...
                0.0D,
                0.0D,
                renderer.getBlockIconFromSideAndMetadata(stone, 2, p_147800_2_));
            renderer.renderFaceZNeg(
                stone,
                0.0D,
                0.0D,
                0.0D,
                renderer.getBlockIconFromSideAndMetadata(overlay, 2, p_147800_2_));
            tessellator.draw();
            tessellator.startDrawingQuads();
            tessellator.setNormal(0.0F, 0.0F, 1.0F);
            renderer.renderFaceZPos(
                ...
                0.0D,
                0.0D,
                renderer.getBlockIconFromSideAndMetadata(stone, 3, p_147800_2_));
            renderer.renderFaceZPos(
                stone,
                0.0D,
                0.0D,
                0.0D,
                renderer.getBlockIconFromSideAndMetadata(overlay, 3, p_147800_2_));
            tessellator.draw();
            tessellator.startDrawingQuads();
            ...
            renderer.renderFaceXNeg(
                ...
                0.0D,
                0.0D,
                renderer.getBlockIconFromSideAndMetadata(stone, 4, p_147800_2_));
            renderer.renderFaceXNeg(
                stone,
                0.0D,
                0.0D,
                0.0D,
                renderer.getBlockIconFromSideAndMetadata(overlay, 4, p_147800_2_));
            tessellator.draw();
            tessellator.startDrawingQuads();
            tessellator.setNormal(1.0F, 0.0F, 0.0F);
            renderer.renderFaceXPos(
                ...
                0.0D,
                0.0D,
                renderer.getBlockIconFromSideAndMetadata(stone, 5, p_147800_2_));
            renderer.renderFaceXPos(
                stone,
                0.0D,
                0.0D,
                0.0D,
                renderer.getBlockIconFromSideAndMetadata(overlay, 5, p_147800_2_));
            tessellator.draw();
            GL11.glTranslatef(0.5F, 0.5F, 0.5F);
        }
    }
        ...
        if (j != 0 && j != 31 && j != 39 && j != 16 && j != 26) {
            if (j == 1) {
                ...
                for (k = 0; k < 2; ++k) {
                    ...
                    tessellator.setNormal(0.0F, -1.0F, 0.0F);
                    renderer
                        .renderFaceYNeg(p_147800_1_, 0.0D, 0.0D, 0.0D, renderer.getBlockIconFromSide(p_147800_1_, 0));
                    tessellator.draw();
                    tessellator.startDrawingQuads();
                    tessellator.setNormal(0.0F, 1.0F, 0.0F);
                    renderer
                        .renderFaceYPos(p_147800_1_, 0.0D, 0.0D, 0.0D, renderer.getBlockIconFromSide(p_147800_1_, 1));
                    tessellator.draw();
                    tessellator.startDrawingQuads();
                    tessellator.setNormal(0.0F, 0.0F, -1.0F);
                    renderer
                        .renderFaceZNeg(p_147800_1_, 0.0D, 0.0D, 0.0D, renderer.getBlockIconFromSide(p_147800_1_, 2));
                    tessellator.draw();
                    tessellator.startDrawingQuads();
                    tessellator.setNormal(0.0F, 0.0F, 1.0F);
                    renderer
                        .renderFaceZPos(p_147800_1_, 0.0D, 0.0D, 0.0D, renderer.getBlockIconFromSide(p_147800_1_, 3));
                    tessellator.draw();
                    tessellator.startDrawingQuads();
                    tessellator.setNormal(-1.0F, 0.0F, 0.0F);
                    renderer
                        .renderFaceXNeg(p_147800_1_, 0.0D, 0.0D, 0.0D, renderer.getBlockIconFromSide(p_147800_1_, 4));
                    tessellator.draw();
                    tessellator.startDrawingQuads();
                    tessellator.setNormal(1.0F, 0.0F, 0.0F);
                    renderer
                        .renderFaceXPos(p_147800_1_, 0.0D, 0.0D, 0.0D, renderer.getBlockIconFromSide(p_147800_1_, 5));
                    tessellator.draw();
                    GL11.glTranslatef(0.5F, 0.5F, 0.5F);
                }
            } else if (j == 27) {
                ...
                for (k = 0; k < 2; ++k) {
                    ...
                    renderer.renderFaceYNeg(
                        ...
                        0.0D,
                        0.0D,
                        renderer.getBlockIconFromSideAndMetadata(p_147800_1_, 0, p_147800_2_));
                    tessellator.draw();
                    tessellator.startDrawingQuads();
                    tessellator.setNormal(0.0F, 1.0F, 0.0F);
                    renderer.renderFaceYPos(
                        ...
                        0.0D,
                        0.0D,
                        renderer.getBlockIconFromSideAndMetadata(p_147800_1_, 1, p_147800_2_));
                    tessellator.draw();
                    tessellator.startDrawingQuads();
                    tessellator.setNormal(0.0F, 0.0F, -1.0F);
                    renderer.renderFaceZNeg(
                        ...
                        0.0D,
                        0.0D,
                        renderer.getBlockIconFromSideAndMetadata(p_147800_1_, 2, p_147800_2_));
                    tessellator.draw();
                    tessellator.startDrawingQuads();
                    tessellator.setNormal(0.0F, 0.0F, 1.0F);
                    renderer.renderFaceZPos(
                        ...
                        0.0D,
                        0.0D,
                        renderer.getBlockIconFromSideAndMetadata(p_147800_1_, 3, p_147800_2_));
                    tessellator.draw();
                    tessellator.startDrawingQuads();
                    tessellator.setNormal(-1.0F, 0.0F, 0.0F);
                    renderer.renderFaceXNeg(
                        ...
                        0.0D,
                        0.0D,
                        renderer.getBlockIconFromSideAndMetadata(p_147800_1_, 4, p_147800_2_));
                    tessellator.draw();
                    tessellator.startDrawingQuads();
                    tessellator.setNormal(1.0F, 0.0F, 0.0F);
                    renderer.renderFaceXPos(
                        ...
                        0.0D,
                        0.0D,
                        renderer.getBlockIconFromSideAndMetadata(p_147800_1_, 5, p_147800_2_));
                    tessellator.draw();
                    GL11.glTranslatef(0.5F, 0.5F, 0.5F);
                }
