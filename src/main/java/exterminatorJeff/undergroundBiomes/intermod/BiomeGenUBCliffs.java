...
public class BiomeGenUBCliffs extends BiomeGenCliffs {
    ...
    public void decorate(World world, Random random, int x, int z) {
        ...
        highlandsDecorator.genOreHighlands(
            world,
            random,
            x,
            z,
            20,
            ((BiomeDecorator) ((BiomeGenBase) this).theBiomeDecorator).ironGen,
            64,
            128);
        highlandsDecorator.genOreHighlands(
            world,
            ...
            z,
            8,
            ((BiomeDecorator) ((BiomeGenBase) this).theBiomeDecorator).redstoneGen,
            16,
            32);
        highlandsDecorator.genOreHighlands(
            world,
            ...
            z,
            1,
            ((BiomeDecorator) ((BiomeGenBase) this).theBiomeDecorator).lapisGen,
            32,
            64);
        highlandsDecorator.genOreHighlands(
            world,
            ...
            z,
            2,
            ((BiomeDecorator) ((BiomeGenBase) this).theBiomeDecorator).goldGen,
            32,
            64);
        highlandsDecorator.genOreHighlands(
            world,
            ...
            z,
            1,
            ((BiomeDecorator) ((BiomeGenBase) this).theBiomeDecorator).diamondGen,
            16,
            32);
    }
