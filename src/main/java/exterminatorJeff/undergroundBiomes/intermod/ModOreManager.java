        ...
        UBOreTexturizer texturizer = UBAPIHook.ubAPIHook.ubOreTexturizer;
        {
            ...
            if (thermalFoundationOreBlock != null) {
                ...
                texturizer.requestUBOreSetup(
                    ...
                    0,
                    UBOreTexturizer.copper_overlay,
                    "tile.thermalfoundation.ore.copper");
                texturizer.requestUBOreSetup(
                    thermalFoundationOreBlock,
                    1,
                    UBOreTexturizer.tin_overlay,
                    "tile.thermalfoundation.ore.tin");
                texturizer.requestUBOreSetup(
                    thermalFoundationOreBlock,
                    2,
                    UBOreTexturizer.silver_overlay,
                    "tile.thermalfoundation.ore.silver");
                texturizer.requestUBOreSetup(
                    thermalFoundationOreBlock,
                    3,
                    UBOreTexturizer.lead_overlay,
                    "tile.thermalfoundation.ore.lead");
            }
        }
        {
            // Thaumcraft
            ...
            if (thaumcraftOreBlock != null) {
                texturizer.requestUBOreSetup(
                    thaumcraftOreBlock,
                    0,
                    UBOreTexturizer.cinnabar_overlay,
                    "tile.blockCustomOre.0");
                texturizer
                    .requestUBOreSetup(thaumcraftOreBlock, 7, UBOreTexturizer.amber_overlay, "tile.blockCustomOre.7");
            }
        }
        {
            // Mekanism
            ...
            if (mekanismBlock != null) {
                texturizer
                    .requestUBOreSetup(mekanismBlock, 1, UBOreTexturizer.copper_overlay, "tile.OreBlock.CopperOre");
        ...
        }
        {
            ...
            if (projectRedBlock != null) {
                texturizer.requestUBOreSetup(
                    projectRedBlock,
                    0,
                    UBOreTexturizer.ruby_overlay,
                    "tile.projectred.exploration.ore|0");
                texturizer.requestUBOreSetup(
                    projectRedBlock,
                    1,
                    UBOreTexturizer.sapphire_overlay,
                    "tile.projectred.exploration.ore|1");
                texturizer.requestUBOreSetup(
                    projectRedBlock,
                    2,
                    UBOreTexturizer.olivine_peridot_overlay,
                    "tile.projectred.exploration.ore|2");
            }
        }
        {
            // Biomes O' Plenty
            ...
            if (bopOreBlock != null) {
                ...
                texturizer.requestUBOreSetup(
                    ...
                    4,
                    UBOreTexturizer.olivine_peridot_overlay,
                    "tile.gemOre.peridotore");
                texturizer
                    .requestUBOreSetup(bopOreBlock, 6, UBOreTexturizer.olivine_peridot_overlay, "tile.gemOre.topazore");
                texturizer.requestUBOreSetup(
                    bopOreBlock,
                    8,
                    UBOreTexturizer.olivine_peridot_overlay,
                    "tile.gemOre.tanzaniteore");
                texturizer
                    .requestUBOreSetup(bopOreBlock, 10, UBOreTexturizer.emerald_overlay, "tile.gemOre.malachiteore");
                texturizer
                    .requestUBOreSetup(bopOreBlock, 12, UBOreTexturizer.sapphire_overlay, "tile.gemOre.sapphireore");
