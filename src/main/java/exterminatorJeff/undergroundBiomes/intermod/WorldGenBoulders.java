...
public class WorldGenBoulders extends WorldGenerator {
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5) {
        ...
        for (boolean var6 = false; (par1World.getBlock(par3, par4, par5) == Blocks.leaves
            || par1World.isAirBlock(par3, par4, par5)) && par4 > 0; --par4) {
            ;
        }
        int dimension = par1World.provider.dimensionId;
        UBStrataColumnProvider columnProvider = UBAPIHook.ubAPIHook.dimensionalStrataColumnProvider
            .ubStrataColumnProvider(dimension);
        BlockCodes cobble = columnProvider.strataColumn(par3, par5)
            .cobblestone(par4);
