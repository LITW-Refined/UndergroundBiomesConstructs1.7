...
public class WorldGenUndergroundUB extends WorldGenerator {
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5) {
        ...
        BlockCodes blockCodes = columnProvider.strataColumn(par3, par5)
            .stone(par4);
                            ...
                            for (int var44 = var34; var44 <= var37; ++var44) {
                                ...
                                if (var39 * var39 + var42 * var42 + var45 * var45 < 1.0D
                                    ...
                                    if (par1World.isAirBlock(var38, var41 + 1, var44) && minableBlockId == Blocks.dirt)
                                        ...
                                        par1World
                                            .setBlock(var38, var41, var44, blockCodes.block, blockCodes.metadata, 3);
                                    }
                                }
                            }
                        }
