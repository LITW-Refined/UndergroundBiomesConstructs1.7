...
public class BiomeGenUBSnowMountains extends BiomeGenBaseHighlands {
    ...
    public void decorate(World world, Random random, int x, int z) {
        ...
        new WorldGenUBMountain(15, 25, false, 0)
            .generate(world, random, x + random.nextInt(16), 128, z + random.nextInt(16));
        ...
        highlandsDecorator
            .genOreHighlands(world, random, x, z, 20, ((BiomeDecoratorHighlands) this.theBiomeDecorator).HLice, 0, 128);

        highlandsDecorator
            .genOreHighlands(world, random, x, z, 20, ((BiomeGenBase) this).theBiomeDecorator.ironGen, 64, 128);
        highlandsDecorator
            .genOreHighlands(world, random, x, z, 8, ((BiomeGenBase) this).theBiomeDecorator.redstoneGen, 16, 32);
        highlandsDecorator
            .genOreHighlands(world, random, x, z, 1, ((BiomeGenBase) this).theBiomeDecorator.lapisGen, 32, 64);
        highlandsDecorator
            .genOreHighlands(world, random, x, z, 2, ((BiomeGenBase) this).theBiomeDecorator.goldGen, 32, 64);
        highlandsDecorator
            .genOreHighlands(world, random, x, z, 1, ((BiomeGenBase) this).theBiomeDecorator.diamondGen, 16, 32);
        highlandsDecorator
            .genOreHighlands(world, random, x, z, 2, ((BiomeGenBase) this).theBiomeDecorator.diamondGen, 0, 32);
    }
