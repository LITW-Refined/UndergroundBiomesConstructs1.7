...
public class BiomeGenUBDesertMountains extends BiomeGenDesertMountains {
    ...
    public void decorate(World world, Random random, int x, int z) {
        ...
        if (random.nextInt(4) == 0) new WorldGenUBMountain(15, 20, false, 2)
        ...
        ((BiomeDecoratorHighlands) ((BiomeGenBase) this).theBiomeDecorator)
        ...
        ((BiomeDecoratorHighlands) ((BiomeGenBase) this).theBiomeDecorator)
            .genOreHighlands(world, random, x, z, 4, ((BiomeGenBase) this).theBiomeDecorator.goldGen, 0, 64);
        ((BiomeDecoratorHighlands) ((BiomeGenBase) this).theBiomeDecorator)
