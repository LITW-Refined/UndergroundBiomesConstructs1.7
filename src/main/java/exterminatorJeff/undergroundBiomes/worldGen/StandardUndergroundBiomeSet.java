...
public class StandardUndergroundBiomeSet extends UndergroundBiomeSet {
    ...
    public final BiomeGenUndergroundBase metamorphic2 = (new BiomeGenUndergroundBase(17, metamorphicID, 1, biomeList))
        .setName("Metamorphic")
        .AddStrataLayers(strataLayers[7]);
    public final BiomeGenUndergroundBase metamorphic3 = (new BiomeGenUndergroundBase(18, metamorphicID, 1, biomeList))// to
                                                                                                                      // stop
                                                                                                                      // marble
                                                                                                                      // from
                                                                                                                      // being
    ...
    public final BiomeGenUndergroundBase metamorphic10 = (new BiomeGenUndergroundBase(25, metamorphicID, 1, biomeList))
        .setName("Metamorphic")
        .AddStrataLayers(strataLayers[5]);
    public final BiomeGenUndergroundBase metamorphic11 = (new BiomeGenUndergroundBase(26, metamorphicID, 1, biomeList))// to
                                                                                                                       // stop
                                                                                                                       // marble
                                                                                                                       // from
                                                                                                                       // being
    ...
    public final BiomeGenUndergroundBase vanillaStone1 = (new BiomeGenUndergroundBase(
        32,
        NamedVanillaBlock.stone,
        0,
        biomeList)).setName("Metamorphic")
            .AddStrataLayers(strataLayers[0]);
    public final BiomeGenUndergroundBase vanillaStone2 = (new BiomeGenUndergroundBase(
        33,
        NamedVanillaBlock.stone,
        0,
        biomeList)).setName("Metamorphic")
            .AddStrataLayers(strataLayers[1]);
    public final BiomeGenUndergroundBase vanillaStone3 = (new BiomeGenUndergroundBase(
        34,
        NamedVanillaBlock.stone,
        0,
        biomeList)).setName("Metamorphic")
            .AddStrataLayers(strataLayers[2]);
    public final BiomeGenUndergroundBase vanillaStone4 = (new BiomeGenUndergroundBase(
        35,
        NamedVanillaBlock.stone,
        0,
        biomeList)).setName("Metamorphic")
    ...
    public BiomeGenUndergroundBase[] allowedBiomes() {
        ...
        if (!UndergroundBiomes.vanillaStoneBiomes()) {
            allowedBiomes = new BiomeGenUndergroundBase[] { igneous1, igneous2, igneous3, igneous4, igneous5, igneous6,
                igneous7, igneous8, igneous9, igneous10, igneous11, igneous12, igneous13, igneous14, igneous15,
                igneous16, metamorphic1, metamorphic2, metamorphic3, metamorphic4, metamorphic5, metamorphic6,
                metamorphic7, metamorphic8, metamorphic9, metamorphic10, metamorphic11, metamorphic12, metamorphic13,
                metamorphic14, metamorphic15, metamorphic16 };
        } else {
            allowedBiomes = new BiomeGenUndergroundBase[] { igneous1, igneous2, igneous3, igneous4, igneous5, igneous6,
                igneous7, igneous8, igneous9, igneous10, igneous11, igneous12, igneous13, igneous14, igneous15,
                igneous16, metamorphic1, metamorphic2, metamorphic3, metamorphic4, metamorphic5, metamorphic6,
                metamorphic7, metamorphic8, metamorphic9, metamorphic10, metamorphic11, metamorphic12, metamorphic13,
                metamorphic14, metamorphic15, metamorphic16, vanillaStone1, vanillaStone2, vanillaStone3,
                vanillaStone4 };
        }
