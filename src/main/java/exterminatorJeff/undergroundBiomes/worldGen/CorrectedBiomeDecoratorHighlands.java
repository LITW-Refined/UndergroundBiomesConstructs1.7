...
public class CorrectedBiomeDecoratorHighlands extends BiomeDecoratorHighlands {
    ...
    public CorrectedBiomeDecoratorHighlands(BiomeGenBase biome, BiomeDecoratorHighlands toCorrect) {
        super(biome, trees(toCorrect), grass(toCorrect), flowers(toCorrect), highlandsPl.get(toCorrect));
        mcthis = this;
    }
     ...
     * int i1 = ((BiomeDecorator)this).randomGenerator.nextInt(((BiomeDecorator)this).currentWorld.getHeightValue(k, l)
     * + 32);
    ...
    @Override
    public void decorateChunk(World world, Random p_150512_2_, BiomeGenBase p_150512_3_, int p_150512_4_,
        int p_150512_5_) {
    ...
    public void func_150513_ab(BiomeGenBase p_150513_1_) {
        ...
        for (j = 0; doGen && j < mcthis.waterlilyPerChunk; ++j) {
            ...
            for (i1 = randomizer.nextInt(world.getHeightValue(k, l) * 2); i1 > 0
                && world.isAirBlock(k, i1 - 1, l); --i1) {
                ;
            }
