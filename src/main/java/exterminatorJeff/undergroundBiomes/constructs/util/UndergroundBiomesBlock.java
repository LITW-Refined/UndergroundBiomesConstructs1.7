...
public class UndergroundBiomesBlock {
    ...
    public final IIcon icon() {
        return ubBlock.getIcon(2, metadata);
    }

    public final String name() {
        return ubBlock.getBlockName(metadata);
    }

    public final float hardness() {
        return ubBlock.getBlockHardness(metadata);
    }

    public final float explosionResistance() {
        return ubBlock.getBlockExplosionResistance(metadata);
    }

    public final ItemStack stack(int items) {
        return new ItemStack(ubBlock, items, metadata);
    }
