...
public class UBStairs extends BlockStairs {
    ...
    public void onBlockDestroyedByPlayer(World p_149664_1_, int p_149664_2_, int p_149664_3_, int p_149664_4_,
        int p_149664_5_) {
        this.baseStone
            .onBlockDestroyedByPlayer(p_149664_1_, p_149664_2_, p_149664_3_, p_149664_4_, blockMetadata(p_149664_5_));
    }
    ...
    public void onBlockPlacedBy(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_,
        EntityLivingBase p_149689_5_, ItemStack placed) {
    ...
    public int onBlockPlaced(World p_149660_1_, int p_149660_2_, int p_149660_3_, int p_149660_4_, int p_149660_5_,
        ...
        int result = p_149660_5_ != 0 && (p_149660_5_ == 1 || (double) p_149660_7_ <= 0.5D) ? p_149660_9_
            : p_149660_9_ | 4;
        return result;
    }

    boolean func_150146_f(IBlockAccess p_150146_1_, int p_150146_2_, int p_150146_3_, int p_150146_4_,
        int p_150146_5_) {
        Block block = p_150146_1_.getBlock(p_150146_2_, p_150146_3_, p_150146_4_);
        return func_150148_a(block)
            && (p_150146_1_.getBlockMetadata(p_150146_2_, p_150146_3_, p_150146_4_) & 7) == p_150146_5_;
    }
