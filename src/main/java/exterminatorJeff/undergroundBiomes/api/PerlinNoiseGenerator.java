...
public class PerlinNoiseGenerator extends NoiseGenerator {
    ...
    protected PerlinNoiseGenerator() {
        int p[] = { 151, 160, 137, 91, 90, 15, 131, 13, 201, 95, 96, 53, 194, 233, 7, 225, 140, 36, 103, 30, 69, 142, 8,
    ...
    public double noise(double x, double y, double z) {
        ...
        return lerp(
            ...
            lerp(
                fY,
                lerp(fX, grad(perm[AA], x, y, z), grad(perm[BA], x - 1, y, z)),
                lerp(fX, grad(perm[AB], x, y - 1, z), grad(perm[BB], x - 1, y - 1, z))),
            lerp(
                fY,
                lerp(fX, grad(perm[AA + 1], x, y, z - 1), grad(perm[BA + 1], x - 1, y, z - 1)),
